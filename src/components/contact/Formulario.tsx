...
export const Formulario: FC<FormularioProps> = ({ lang }) => {
  ...
  return (
    <form className='w-full max-w-lg'>
      ...
      <button type="submit" className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm w-full sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        {lang.submit}
      </button>
    </form>
