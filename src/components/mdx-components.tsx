...
const components = {
    ...
    h3: ({ className, ...props }) => <h3 className={cn('mt-10 scroll-m-20 text-2xl font-extrabold tracking-tight', className)} {...props} />,
    h4: ({ className, ...props }) => <h4 className={cn('mt-10 scroll-m-20 text-xl font-semibold tracking-tight', className)} {...props} />,
    h5: ({ className, ...props }) => <h5 className={cn('mt-10 scroll-m-20 text-lg font-semibold tracking-tight', className)} {...props} />,
    h6: ({ className, ...props }) => <h6 className={cn('mt-10 scroll-m-20 text-base font-semibold tracking-tight', className)} {...props} />,
    a: ({ className, ...props }) => <a className={cn('font-medium underline underline-offset-4', className)} {...props} />,
    p: ({ className, ...props }) => <p className={cn('leading-6 [&:not(:first-child)]:mb-6 mt-2', className)} {...props} />,
