...
export const Works: FC<WorksProps> = async ({ lang }) => {
  ...
  return (
    <section id='works' className='flex flex-col justify-center items-start w-full pt-20 gap-10'>
      ...
      <Link href={"#"} className=" flex flex-row justify-center items-center gap-2 text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-md px-5 py-2.5 dark:bg-primary dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition-colors duration-300">
        {works.add}
        <i>
